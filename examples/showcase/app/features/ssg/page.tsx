    ...
    <div className="page">
      <div className="page-header">
        ...
        <p className="page-description">
          Pre-render pages at startup, serve from memory — zero SSR on every
          request.
        </p>
      </div>
      ...
      <div className="demo-card" style={{ marginBottom: "24px" }}>
        ...
        <p className="demo-card-description">
          This page was rendered at startup and cached in memory. Every request
          gets the identical HTML instantly — no component execution, no JSX
          rendering, no template processing.
        </p>
        <div
          style={{
        ...
        >
          ...
          >
            Refresh this page — the timestamp stays the same!
          </div>
...
export default function AboutPage() {
  ...
  return <main><h1>About Us</h1><p>Built: {builtAt}</p></main>;
      ...
      <div className="demo-card" style={{ marginBottom: "24px" }}>
        ...
        <p className="demo-card-description">
          Three ways to invalidate the SSG cache:
        </p>
        <div className="code-block">
  ...
  return new Response('Cache cleared');
      ...
      <div className="demo-card" style={{ marginBottom: "24px" }}>
        <h3 className="demo-card-title">
          📊 Live Benchmark: SSG vs SSR vs Cached SSR
        </h3>
        <p className="demo-card-description">
          Runs 100 iterations of each rendering strategy and compares response
          times. The chart below auto-loads when you visit this page.
        </p>
        <div
          id="benchmark-chart"
          style={{
      ...
      <div className="demo-card">
        ...
        >
          <li>
            <strong>Marketing pages</strong> — homepage, about, pricing (content
            rarely changes)
          </li>
          <li>
            <strong>Documentation</strong> — reference pages, API docs,
            changelogs
          </li>
          <li>
            <strong>Blog posts</strong> — render once, serve to millions
          </li>
          <li>
            <strong>Landing pages</strong> — maximum performance for first
            impressions
          </li>
          <li style={{ color: "#f59e0b" }}>
            <strong>NOT for:</strong> dashboards, user profiles, real-time data
            (use SSR instead)
          </li>
        </ul>
      </div>
