  ...
  return (
    <div className="page">
      <Head>
        ...
        <meta
          name="description"
          content="This page demonstrates the Head component for declarative head tag management."
        />
      ...
      <div className="page-header">
        ...
        <p className="page-description">
          Declarative head tag management — set title, meta, and link tags from
      ...
      <div className="demo-card" style={{ marginBottom: "24px" }}>
        ...
        <p className="demo-card-description">
          Open your browser's <strong>developer tools</strong> and check the{" "}
          <code>{"<head>"}</code> section. You'll see:
        </p>
        <ul
          style={{
        ...
        >
          <li>
            <strong>Custom title</strong> — "Head Demo — Custom Page Title |
            Melina.js" (check the browser tab)
          </li>
          <li>
            <strong>Meta description</strong> — SEO-friendly page description
            for search engines
          </li>
          <li>
            <strong>Theme color</strong> — <code>#6366f1</code> (indigo, visible
            in mobile browsers)
          </li>
          <li>
            <strong>Custom favicon</strong> — 🧠 emoji as the page icon
          </li>
        </ul>
      </div>
